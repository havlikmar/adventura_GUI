...
public class HerniPlan implements Observable{
    ...
    private void zalozLokaceHry() {
        ...
        Predmet klicOdTruhly = new Predmet("klíč_od_truhly", "starý zdobený klíč od truhly", true, false, "klic.png");
        Predmet krumpac = new Predmet("krumpáč", "starý krumpáč pro těžbu", true, true, "důl", "drahokamy", "Kutáš, kutáš a najednou ze zdi vypadne malý drahokam", "už jsi tady kutal", "krumpac.png");
        Predmet buchty = new Predmet("buchty", "čerstvě upečené buchty", true, true, "buchty.png");
        Predmet bylinky = new Predmet("bylinky", "léčebné bylinky", true, true, "okraj_lesa", "lektvar", "Dáš bylinky vařit a za chvíli roztok změní barvu. Lektvar je na světě","Už jsi lektvar uvařil", "bylinky.png");
        Predmet zdrojMoci = new Predmet("zdroj_moci", "zářivá kulička. Zdroj jezdcovi moci", true, false, "moc.png");
        Predmet pistalka = new Predmet("píšťalka", "stará vyřezávaná píšťalka", true, true, "jeskyně", "dno_studně", "Zapíškáš na píšťalku a krysy odkráčejí ven. Za nimi se objevil otvor", "Už píštalku použil.", "pistalka.png");
        Predmet drahokamy = new Predmet("drahokamy", "nefalšované drahokamy", true, false, "drahokamy.png");
        Predmet klicOdPasti = new Predmet("klíč_od_pasti", "klíč od pasti medvíděte", true, true, "les", "medvídě", "Odemkneš past a medvídě štastně klopýtá do lesa", "Už jsi medvídě osvobodil", "klic.png");
        Predmet lopata = new Predmet("lopata", "rezava lopata", true, true, HLUBOKY_LES, "pytlík_peněz", "Kopeš, kopeš a najednou objevíš pytlík plný zlaťáků", "Už jsi tady kopal", "lopata.png");
        Predmet pytlikPenez = new Predmet("pytlík_peněz", "pytlík peněz", true, false, "pytlik.png");
        Predmet povoleniPlavby = new Predmet("povolení_plavby", "povolení k užití lodě", true, true, "papir.png");
        Predmet truhla = new Predmet("truhla", "velká zdobená truhla", false, "klíč_od_truhly", "poklad", "Odemykáš krásnou ozdobnou truhlu.", "Truhlu jsi již odemkl", true, "truhla.png");
        Predmet mec = new Predmet("meč", "čistý, lesklý, nový meč", true, true, "konec_jeskyně", "vlkodlak", "Vlkodlak se probouzí. Vrhá na tebe vrhne a ty ho zasahuješ. Vzápětí umírá v hrozných bolestech", "Už jsi vlkodlaka zabil.", "mec.png");
        Predmet poklad = new Predmet("poklad", "poklad nevyčíslitelné hodnoty", true, false, "poklad.png");
        Predmet klic = new Predmet("klíč", "tajemný klíč", true, false, HLUBOKY_LES, "chaloupka", "Dáš klíč do zámku a otočíš jím. Vzápětí se dveře otevřou", "Už jsi dveře otevřel.", "klic.png");
        Predmet klada = new Predmet("kláda", "kláda na hromadě kamenů ", false, true, HLUBOKY_LES, "jeskyně", "Zatlačíš na kládu a najednou se kameny sesunou a zasypou jeskyni", "Už jsi kládu použil.", "klada.png");
        Predmet recept = new Predmet("recept","K výrobě lektvaru jsou potřeba bylinky z nedalekého lesa. Dej je vařit nad ohněm a lektvar je na světě.", true, false, "papir.png");
        Predmet lektvar = new Predmet("lektvar", "lektvar proti kletbě", true, false, "lektvar.png");
        Predmet talisman = new Predmet("talisman","talisman, který ruší účinky ochrané kletby", true, true, "talisman.png");
        Predmet truhlicka = new Predmet("truhlička", "tajemná truhlička, kterou obklopuje tajemná záře", false, "talisman", "zdroj_moci", "Nasadíš si talisman dojdeš k předmětu a on se otevře. Vypadne z něj zářivá kulička", "Už jsi truhličku otevřel", true, "truhla.png");
