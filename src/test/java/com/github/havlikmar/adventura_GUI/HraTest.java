package com.github.havlikmar.adventura_GUI;
...
public class HraTest {
    ...
    public void tearDown() {
		HerniPlan.setZachranilMedvide(false);
		HerniPlan.setPotkalJezdce(false);
		HerniPlan.setZavalenyVchod(false);
		HerniPlan.setVerzeKonce(-1);
    }
    ...
    public void testZiskaniZlataku() {
        ...
        Predmet lopata = new Predmet("lopata", "rezava lopata", true, true, "hluboký_les", "pytlík_peněz", "Kopeš, kopeš a najednou objevíš pytlík plný zlaťáků", "Už jsi tady kopal", hra1.getHerniPlan());
    ...
    public void testCestaLesJeskyne() {
        ...
        Predmet pistalka = new Predmet("píšťalka", "stará vyřezávaná píšťalka", true, true, "jeskyně", "dno_studně", "Zapíškáš na píšťalku a krysy odkráčejí ven", "Už píštalku použil.", hra1.getHerniPlan());
        ...
        Predmet mec = new Predmet("meč", "čistý, lesklý, nový meč", true, true, "konec_jeskyně", "vlkodlak", "Vlkodlak se na tebe vrhne a ty ho zasahuješ. Vzápětí umírá v hrozných bolestech", "Už jsi vlkodlaka zabil.", hra1.getHerniPlan());
    ...
    public void testPrubehHry1() {
        ...
        hra1.getHerniPlan();
		assertEquals(1,HerniPlan.getVerzeKonce());
        assertEquals(false, hra1.konecHry());
    ...
    public void testPrubehHry2() {
        ...
        assertTrue(hra1.getHerniPlan().getAktualniLokace().getPredmet(KLIC_OD_TRUHLY).isViditelny());
        hra1.getHerniPlan();
		assertEquals(0,HerniPlan.getVerzeKonce());
        assertEquals(false, hra1.konecHry());
        hra1.zpracujPrikaz("polož klíč");
        hra1.zpracujPrikaz("vezmi klíč_od_truhly");
        assertTrue(hra1.getHerniPlan().getAktualniLokace().getPredmet("truhla").isZamknuty());
    ...
    public void testPrubehHry3() {
        ...
        assertTrue(hra1.getHerniPlan().getAktualniLokace().getPredmet(KLIC_OD_TRUHLY).isViditelny());
        hra1.getHerniPlan();
		assertEquals(2,HerniPlan.getVerzeKonce());
        assertEquals(true, hra1.konecHry());
    }
    ...
    public void testLzeMenitKonec() {
        Predmet klic = new Predmet(KLIC, "tajemný klíč", true, true, HLUBOKY_LES, CHALOUPKA, "Dáš klíč do zámku a otočíš jím. Vzápětí se dveře otevřou", "Už jsi dveře otevřel.", hra1.getHerniPlan());
        Predmet klicOdPasti = new Predmet("klíč_od_pasti", "klíč od pasti medvíděte", true, true, LES, "medvídě", "Odemkneš past a medvídě štastně klopýtá do lesa", "Už jsi medvídě osvobodil", hra1.getHerniPlan());
        Predmet mec = new Predmet("meč", "čistý, lesklý, nový meč", true, true, CHALOUPKA, "tajemný_jezdec", "Jezdec se na tebe vrhá. Ty ho zasáhneš, bohužel meč se v něm zasekl. Vypadá to, že jezdec je nazastavitelný a pronásleduje tě z chaloupky.", "Jezdec je již mrtvý.", hra1.getHerniPlan());
        ...
        hra1.zpracujPrikaz(JDI_LES);
        hra1.getHerniPlan();
		assertFalse(HerniPlan.getZachranilMedvide());
        hra1.zpracujPrikaz("použij klíč_od_pasti");
		assertTrue(HerniPlan.getZachranilMedvide());
        hra1.zpracujPrikaz("jdi hluboký_les");
		assertFalse(HerniPlan.getZavalenyVchod());
        hra1.zpracujPrikaz("použij kláda");
		assertTrue(HerniPlan.getZavalenyVchod());
        hra1.zpracujPrikaz("odemkni chaloupka");
        hra1.zpracujPrikaz(JDI_CHALOUPKA);
		assertFalse(HerniPlan.getPotkalJezdce());
        hra1.zpracujPrikaz(POUZIJ_MEC);
		assertTrue(HerniPlan.getPotkalJezdce());
    }
}