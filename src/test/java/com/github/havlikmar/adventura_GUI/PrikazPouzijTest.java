...
public class PrikazPouzijTest {
    ...
    public void testLzePouzitVec() {
        Predmet vec1 = new Predmet("vec1", "", true, true, LOKACE1, VEC3, POPRVE, PODRUHE,"neni potřeba"); // v této lokaci jde použít
        Predmet vec2 = new Predmet("vec2", "", true, true, LOKACE2, VEC3, POPRVE, PODRUHE,"neni potřeba"); // v této lokaci nejde použít
        Predmet vec3 = new Predmet(VEC3, "", true, false,"neni potřeba"); // věc co dostanu
        Predmet vec4 = new Predmet(KLADA, "", false, true, LOKACE1, LOKACE2, POPRVE, PODRUHE,"neni potřeba"); // kontrola klády
        Predmet vec5 = new Predmet("klíč", "", true, true,"neni potřeba"); // klíč
        
        Lokace lokace1 = new Lokace(LOKACE1,"",true, 247.00, 308.00); // současná lokace
    ...
    public void testLzePouzitOstatni() {
        Predmet vec1 = new Predmet("vec1", "", true, true, LOKACE1, BYTOST, POPRVE, PODRUHE,"neni potřeba"); // cílem je bytost
        Predmet vec2 = new Predmet("vec2", "", true, true, LOKACE1, LOKACE3, POPRVE, PODRUHE,"neni potřeba"); 
        
        Lokace lokace1 = new Lokace(LOKACE1, "", true, 247.00, 308.00);
        Lokace lokace2 = new Lokace(LOKACE2, "", true, 247.00, 308.00);
        Lokace lokace3 = new Lokace(LOKACE3, "", false, 247.00, 308.00);
