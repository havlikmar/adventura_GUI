...
public class PrikazOdemkniTest {
    ...
    public void testLzeodemknout() {
        Predmet vec1 = new Predmet("vec1", "", true, true, "lokace1", LOKACE2, POPRVE, "podruhe", hra1.getHerniPlan()); //klíč lokace
        Predmet vec2 = new Predmet(VEC2, "", true, false, hra1.getHerniPlan()); // věc co dostanu
        Predmet vec3 = new Predmet("vec3", "", true, true, hra1.getHerniPlan()); // klíč předmět
        Predmet vec4 = new Predmet(VEC4, "", false, "vec3", VEC2, POPRVE, "podruhe", true, hra1.getHerniPlan()); // co odemkne
